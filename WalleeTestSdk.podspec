Pod::Spec.new do |s|
  ...
  s.author       = "wallee AG"
  s.homepage     = "https://github.com/WhiteLabelGithubOwnerName/msdk-testing-productionRepository"
  s.source       = { :git => "https://github.com/WhiteLabelGithubOwnerName/msdk-testing-productionRepository.git", :tag => "1.5.0" }
